<!-- Start Footer -->
<!-- bg-dark  -->
<footer class="footColor" id="tempaltemo_footer">
  <div class="container">
    <div class="row">
      <div class="col-md-6 pt-5">
        <h2 style="color: #e5e9ec" class="h2 border-bottom pb-3 border-light logo">
          Contact us
        </h2>
      ...
      <div class="col-md-6 pt-5">
        ...
        <ul class="list-unstyled text-light footer-link-list">
          ...
          <li>
            <a class="text-decoration-none" href="contact.php">Locations</a>
          </li>
          <li><a class="text-decoration-none" href="shop.php">Shop</a></li>
          <li><a class="text-decoration-none" href="contact.php#registerForm">Register</a></li>
        </ul>
      </div>
    </div>
