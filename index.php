  ...
  <div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="container">
          <div class="row p-5">
            <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
              <img class="img-fluid" src="./assets/newimgs/Hero1.jpg" alt="" />
            </div>
            <div class="col-lg-6 mb-0 d-flex align-items-center">
              <div class="text-align-left align-self-center">
                <h1 class="h1 text-success"><b>Joined+</b> eCommerce</h1>
                <h3 class="h2">Tiny and Perfect eCommerce Template</h3>
                <p>
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Fugit, optio esse. Adipisci earum harum placeat saepe quos
                  beatae magni expedita, a doloremque pariatur facilis! Nobis
                  sunt facilis odio. Ad, consectetur.
      ...
      <div class="carousel-item">
        <div class="container">
          <div class="row p-5">
            <div class="mx-auto col-md-8 col-lg-6 order-lg-last secondSlide">
              <img class="img-fluid" src="./assets/newimgs/Hero2.jpg" alt="" />
            </div>
            <div class="col-lg-6 mb-0 d-flex align-items-center">
              <div class="text-align-left">
                ...
                <p>
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Obcaecati sunt odit inventore veniam veritatis repellat

                  <strong>fugit iste incidunt</strong>, placeat fugiat fuga?
                  In amet illum, dignissimos accusamus error laudantium
                  blanditiis dolore.
                </p>
              </div>
            </div>
          ...
          <div class="row p-5">
            ...
            <div class="col-lg-6 mb-0 d-flex align-items-center">
              <div class="text-align-left">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Provident fugit accusamus voluptatum non nobis perspiciatis
                  aut, dolorum at magnam repellat nemo eaque quae minima totam
                  distinctio magni labore neque explicabo.
                </p>
              </div>
            </div>
          </div>
  ...
  <section class="container py-5">
    ...
    <div class="row">
      <div class="col-12 col-md-4 p-5 mt-3">
        <a href="#"><img src="./assets/newimgs/circleWatch.jpeg" class="rounded-circle img-fluid border" /></a>
        <h5 class="text-center mt-3 mb-3">Watches</h5>
        <p class="text-center"><a href="shop.php" class="btn btn-success">Go Shop</a></p>
      </div>
      <div class="col-12 col-md-4 p-5 mt-3">
        <a href="#"><img src="./assets/newimgs/circleSneaker.jpeg" class="rounded-circle img-fluid border" /></a>
        <h2 class="h5 text-center mt-3 mb-3">Shoes</h2>
        <p class="text-center"><a href="shop.php" class="btn btn-success">Go Shop</a></p>
      </div>
      <div class="col-12 col-md-4 p-5 mt-3">
        <a href="#"><img src="./assets/newimgs/circleSunglass.jpg" class="rounded-circle img-fluid border" /></a>
    ...
    <div class="container py-5">
      ...
      <div class="row">
        <div class="col-12 col-md-4 mb-4">
          <div class="card h-100 hoverContainer">
            <a href="shop.php">
              <!-- img/feature_prod_01.jpg -->
              <img src="./assets/newimgs/normal1.jpg" class="card-img-top normalimg" alt="..." />
              <!-- <div class="hoverimg">
                <img src="assets/newimgs/hover1.jpg" alt="Shoe" style="height: 331px" />
              </div> -->
            </a>
            <div class="card-body">
              ...
              <a href="shop.php" class="h2 text-decoration-none text-dark">Gym Weight</a>
              <p class="card-text">
          ...
          <div class="card h-100 hoverContainer">
            <a href="shop.php">
              <!-- <img
                  ...
                  alt="..."
                /> -->
              <img src="./assets/newimgs/nwatch1.jpg" class="card-img-top normalimg" alt="..." />
              <!-- <div class="hoverimg">
                <img src="assets/newimgs/hwatch.jpg" alt="Watch" style="height: 321px" />
              </div> -->
            </a>
            <div class="card-body">
              <ul class="list-unstyled d-flex justify-content-between">
              ...
              <a href="shop.php" class="h2 text-decoration-none text-dark">Cloud Nike Shoes</a>
              <p class="card-text">
        ...
        <div class="col-12 col-md-4 mb-4">
          <div class="card h-100 hoverContainer">
            <a href="shop.php">
              <img src="./assets/newimgs/nSunglass.jpg" class="card-img-top normalimg" alt="Sunglass" />
              <!-- <div class="hoverimg">
                <img src="assets/newimgs/hSunglass.jpg" alt="Sunglass" style="height: 331px" />
              </div> -->
            </a>
            <div class="card-body">
              <ul class="list-unstyled d-flex justify-content-between">
              ...
              <a href="shop.php" class="h2 text-decoration-none text-dark">Summer Addides Shoes</a>
              <p class="card-text">
