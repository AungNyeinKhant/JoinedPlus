...
<div class="container-fluid pt-4 px-4">
    <h1 style="text-align: center;color:  #5b7c99;">Seller Table</h1>
    ...
    <table class="table tableone">
        ...
        $query = "SELECT * FROM seller WHERE status='1'";
        ...
        ?>
            ...
            <tbody>
                <tr>
                    ...
                    <!-- <td>14.3.2023</td> -->
                    <td>
                        <a href="selEdit.php?transfer=<?php echo $seller['seller_id']; ?>">Edit</a>
                    </td>
                    <td>
                        <a href="selDel.php?pass=<?php echo $seller['seller_id']; ?>">Delete</a>
                    </td>
                </tr>
