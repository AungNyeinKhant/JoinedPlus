...
if (isset($_POST["sbtn"])) {
  ...
  $sql = "INSERT INTO seller (name,imgfile,phone,address,bankname,bankno,gmail,gender,status) VALUES ('$name','$filename','$phone','$address','$bankname','$bankno','$gmail','$gender',1) ";
...
<div class="container-fluid pt-4 px-4">
  ...
  <h1 style="text-align: center;color:  #5b7c99; ">Seller Register Form</h1>
  <form action="" enctype="multipart/form-data" method="POST">
    <div class="row">
      <div class="form-group ">
        <label for="firstName">FUll Name</label>
        <input id="firstName" class="form-control" type="text" name="sname" required>
      </div>
    ...
    <div class="row">
      <div class="form-group col-6">
        ...
        <input id="cphone" class="form-control" type="text" name="sphone">
      </div>
      <div class="form-group col-6">
    ...
    <div class="form-group">
      ...
      <input id="semail" class="form-control" type="email" required name="semail" required>
    </div>

    <div class="form-group">
      <label for="address">Address</label>
      <input id="caddress" class="form-control" type="text" name="saddress">
    </div>
    ...
    <div class="form-group">
      ...
      <input id="cimage" class="form-control" type="file" name="simage">
    </div>

    <div class="form-group">
      <label for="bank">Bank account</label>
      <input id="cbno" class="form-control" type="text" name="sbno" placeholder="FXO-193432">
    </div>
    <input id="kpay" class="form-check-input" type="radio" name="sbname" value="kpay">
    <label for="kpay" class="form-check-label">Kbzpay</label>
    <input id="wavepay" class="form-check-input" type="radio" name="sbname" value="wavepay">
    <label for="wavepay" class="form-check-label">Wavepay</label>
    <input id="ayapay" class="form-check-input" type="radio" name="sbname" value="kpay">
    <label for="ayapay" class="form-check-label">Ayapay</label>
    <br /><br />


    <button name="sbtn" id="sbtn" class="btn btn-primary" style="margin-left: 15px;" type="submit">Register</button>
